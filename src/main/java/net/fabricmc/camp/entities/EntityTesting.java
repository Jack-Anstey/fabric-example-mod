...
public class EntityTesting implements ModInitializer {
     ...
     */
    public static final EntityType<ExampleHostileEntity>  exampleHostileEntityEntityType = Registry.register(
            Registry.ENTITY_TYPE,
            new Identifier("camp", "examplehostileentity"),
            FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, ExampleHostileEntity::new).dimensions(EntityDimensions.fixed(0.75f, 0.75f)).build()
    );
    ...
    public void onInitialize() {
         ...
         */
        FabricDefaultAttributeRegistry.register(exampleHostileEntityEntityType, ExampleHostileEntity.createMobAttributes());
    }
}